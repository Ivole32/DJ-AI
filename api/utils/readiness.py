...
def ensure_ready(
    ...
    *,
    ...
    method does not exist or is not callable, an HTTP 500 error is raised.
    ...
    Raises:
        HTTPException:
            - 500 Internal Server Error if the readiness method is missing
              or not callable.
            - 503 Service Unavailable if the object reports it is not ready.
              The optional status message is included in the response.
    """
    # Get the readiness checker method and raise 500 if missing
